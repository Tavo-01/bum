...
public class Agenda {
  ...
  * @return devuelve contacto añadido si se realiza correctamente o exception
  * @throws ContactoRepetidoException , excepcion especifica programada en el paquete exception
  */
